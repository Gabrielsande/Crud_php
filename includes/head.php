...
.greeting-text { color: var(--text-muted); font-size: 14px; margin-right: 10px; }
...
.btn-primary:hover {
  box-shadow: 0 6px 28px rgba(124, 106, 255, 0.5);
...
.btn-danger:hover { background: rgba(255, 90, 126, 0.18); }
...
.page-count { font-size: 13px; color: var(--text-muted); margin-top: 4px; }
...
tbody td { padding: 16px 20px; font-size: 14px; color: var(--text); }
...
.badge-m { background: rgba(99, 179, 255, 0.12); color: #63b3ff; }
.badge-f { background: rgba(255, 106, 158, 0.12); color: #ff6a9e; }
...
.alert-danger {
  background: var(--danger-bg);
  border-color: rgba(255, 90, 126, 0.25);
  color: var(--danger);
}
